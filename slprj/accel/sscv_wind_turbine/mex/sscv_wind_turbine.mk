...
MODEL                   = sscv_wind_turbine
MODULES                 = sscv_wind_turbine_acc.c rtGetInf.c rt_nonfinite.c sscv_wind_turbine_acc_data.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\sscv_wind_turbine_acc.mexw64
MAKEFILE                = sscv_wind_turbine.mk
MATLAB_ROOT             = C:\Program Files\MATLAB\R2025b
ALT_MATLAB_ROOT         = C:\PROGRA~1\MATLAB\R2025b
START_DIR               = C:\Users\Viktor\Documents\MATLAB\Examples\R2025b\simscape_shared\WindTurbineExample
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 74
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:sscv_wind_turbine_acc.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
MODELLIB                  = sscv_wind_turbine_acc.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = sscv_wind_turbine_ref.rsp
COMPILER_COMMAND_FILE     = sscv_wind_turbine_comp.rsp
...
sscv_wind_turbine_acc.obj : $(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc.c

rtGetInf.obj : $(START_DIR)\slprj\accel\sscv_wind_turbine\rtGetInf.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\sscv_wind_turbine\rtGetInf.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\sscv_wind_turbine\rtGetInf.c

rt_nonfinite.obj : $(START_DIR)\slprj\accel\sscv_wind_turbine\rt_nonfinite.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\sscv_wind_turbine\rt_nonfinite.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\sscv_wind_turbine\rt_nonfinite.c

sscv_wind_turbine_acc_data.obj : $(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc_data.c
	@cmd /C echo ### Compiling "$(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc_data.c"
	$(CC) $(CFLAGS) $(START_DIR)\slprj\accel\sscv_wind_turbine\sscv_wind_turbine_acc_data.c
